...
class ProxyClusterFilterSetTestCase(TestCase):
    ...
    def test_filter_by_name(self):
        fs = ProxyClusterFilterSet(
            {"name": "alpha"}, queryset=ProxyCluster.objects.all()
        )
    ...
    def test_filter_by_name_icontains(self):
        fs = ProxyClusterFilterSet(
            {"name": "cluster"}, queryset=ProxyCluster.objects.all()
        )
...
class ProxyUpstreamServerFilterSetTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.upstream = ProxyUpstream.objects.create(
            cluster=cluster, name="srv-upstream"
        )
...
class ProxyLocationFilterSetTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.upstream = ProxyUpstream.objects.create(
            cluster=cluster, name="loc-upstream"
        )
